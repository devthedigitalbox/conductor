...
namespace WorkflowCore.Services
{
    public class TransientMemoryPersistenceProvider : IPersistenceProvider
    {
        ...
        public Task MarkEventQueued(string id, CancellationToken _ = default) => _innerService.MarkEventProcessed(id);

        public Task MarkEventUnqueued(string id, CancellationToken _ = default) => _innerService.MarkEventUnprocessed(id);
