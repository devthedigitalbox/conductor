...
namespace WorkflowCore.Interface
{
    public interface IEventRepository
    {
        ...
        Task MarkEventQueued(string id, CancellationToken cancellationToken = default);

        Task MarkEventUnqueued(string id, CancellationToken cancellationToken = default);
