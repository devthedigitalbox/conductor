...
namespace Conductor
{
    ...
    {        
        ...
        public static int? PollingInterval => string.IsNullOrEmpty(Environment.GetEnvironmentVariable("pollinginterval")) ? default(int?) : int.Parse(Environment.GetEnvironmentVariable("pollinginterval"));
